...
Both Cowork and Claude Code use `mcp__mcp-tools-istefox__append_to_vault_file`.
...
mcp__mcp-tools-istefox__create_vault_directory("99 - Méta/AI/Telemetry")

mcp__mcp-tools-istefox__append_to_vault_file(
  path    = LOG_FILE,
...
**Verified:** `.ndjson` extension accepted by istefox, bytes preserved verbatim (no markdown coercion). Tested 2026-05-26.
