...
| [`session-telemetry`](plugins/session-telemetry/) | 0.1.0 | in-repo | Captures a structured snapshot of the current Claude session and appends one NDJSON line to the Organon vault telemetry log via istefox MCP. |
